...
public class EventWrapper implements Event, ModelWrapper<Event> {
    ...
    */
    ...
    @Override
    public int compareTo(com.cofares.ejemplo.eventlisting.model.Event event) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.cofares.ejemplo.eventlisting.model.Event> toCacheModel() {
        return _event.toCacheModel();
    }

    @Override
    public com.cofares.ejemplo.eventlisting.model.Event toEscapedModel() {
        return new EventWrapper(_event.toEscapedModel());
    }

    @Override
    public com.cofares.ejemplo.eventlisting.model.Event toUnescapedModel() {
