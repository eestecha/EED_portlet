...
import com.cofares.ejemplo.eventlisting.NoSuchEventException;
import com.cofares.ejemplo.eventlisting.model.Event;
import com.cofares.ejemplo.eventlisting.model.impl.EventImpl;
import com.cofares.ejemplo.eventlisting.model.impl.EventModelImpl;
import com.cofares.ejemplo.eventlisting.service.persistence.EventPersistence;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
    ...
    @Override
    public Event updateImpl(com.cofares.ejemplo.eventlisting.model.Event event)
        throws SystemException {
        event = toUnwrappedModel(event);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.cofares.ejemplo.eventlisting.model.Event")));
