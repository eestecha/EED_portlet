...
public class LocationClp extends BaseModelImpl<Location> implements Location {
    ...
    private Class<?> _clpSerializerClass = com.cofares.ejemplo.eventlisting.service.ClpSerializer.class;
    ...
    public int compareTo(Location location) {
        ...
        value = getName().compareToIgnoreCase(location.getName());
    ...
    public String toXmlString() {
        ...
        sb.append("com.cofares.ejemplo.eventlisting.model.Location");
