...
public class LocationWrapper implements Location, ModelWrapper<Location> {
    ...
    */
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.cofares.ejemplo.eventlisting.model.Location> toCacheModel() {
        return _location.toCacheModel();
    }

    @Override
    public com.cofares.ejemplo.eventlisting.model.Location toEscapedModel() {
        return new LocationWrapper(_location.toEscapedModel());
    }

    @Override
    public com.cofares.ejemplo.eventlisting.model.Location toUnescapedModel() {
